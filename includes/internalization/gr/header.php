		<header class="col-sm-12 col-md-12 col-lg-12">
			<div id="lang-control">
				...
				<a title="Ελληνικά" href="<?= constant('BASEURL') ?>/gr/<?= $links['gr'] ?>"><img alt="image of the Greek flag" class="l-img" src="<?= constant('BASEURL') ?>/images/gr.jpg"/></a>
				<a title="Αγγλικά" href="<?= constant('BASEURL') ?>/en/<?= $links['en'] ?>"><img alt="image of United Kingdom's flag" class="l-img" src="<?= constant('BASEURL') ?>/images/uk.png"/></a>
			</div>
			...
			<div class="col-sm-12 col-md-6 col-lg-6 text-center">
				...
				<div id="slideshow" data-base-url="<?= constant('BASEURL') ?>"></div>
			</div>
